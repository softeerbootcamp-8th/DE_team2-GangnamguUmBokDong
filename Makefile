PROJECTS := collector apps/api airflow ml/inference ml/training ml/feature_engine libs/core libs/ml_common normalizer nowcaster loader
LOCAL_TEST_PROJECTS := collector apps/api ml/inference ml/training ml/feature_engine libs/core libs/ml_common normalizer nowcaster loader
CI_TEST_PROJECTS := collector apps/api libs/core libs/ml_common normalizer nowcaster loader
