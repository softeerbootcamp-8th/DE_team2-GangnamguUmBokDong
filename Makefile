PROJECTS := collector apps/api airflow ml/inference ml/training ml/feature_engineering libs/core libs/ml_common seoul-pop-normalizer
LOCAL_TEST_PROJECTS := collector apps/api ml/inference ml/training ml/feature_engineering libs/core libs/ml_common seoul-pop-normalizer
