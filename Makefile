PROJECTS := collector apps/api airflow ml/inference ml/training ml/feature_engine libs/core libs/ml_common seoul-pop-normalizer seoul-pop-nowcasting loader
LOCAL_TEST_PROJECTS := collector apps/api ml/inference ml/training ml/feature_engine libs/core libs/ml_common seoul-pop-normalizer seoul-pop-nowcasting loader
CI_TEST_PROJECTS := collector apps/api libs/core libs/ml_common seoul-pop-normalizer seoul-pop-nowcasting loader
