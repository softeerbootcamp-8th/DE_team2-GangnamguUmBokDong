...
function StationMarkers({ stations, alerts, selectedStationId, onSelect, mapFilterMode }: Props) {
...
export function StationMap({ stations, alerts, selectedStationId, onSelect, mapFilterMode }: Props) {
  return (
    <MapContainer
