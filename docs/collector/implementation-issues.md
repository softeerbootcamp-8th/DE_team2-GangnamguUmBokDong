...
[구현 계획 11절](./implementation-plan.md#11-구현-순서)의 9단계를 11개로 나눴다. 의존성 추가를 앞으로 뺐고(#2·#3·#4를 병렬로 돌리려면 먼저 병합돼야 한다), "기상청 어댑터 + YAML 7종"은 성격이 달라 #9·#10으로 분리했다. #11은 실제 마커가 쌓여야 검증할 수 있어 #10 뒤에 둔다.
