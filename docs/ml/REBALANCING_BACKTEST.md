...
- 예측 보호 구간: 2시간
- 최소 재고: 정원의 20%
- 회수 안전재고 전략: `poisson-mean`(production 기본값)
...
같은 production 180분의 시간별 재고 잔차를 역산하면 기존 운영의 균형 이동량은
644대이고, 작업 시각을 구간 시작·중간·끝으로 가정한 품절 대여소-분은
51,682.7~52,655.4분이다. 따라서 `no_rebalance` 52,593.8분 대비 기존 운영은
0.1% 악화~1.7% 개선 범위이고, v5는 399대를 이동해 13.162% 개선했다.

- 기존 운영에 가장 유리한 경우의 감축량: 911.1 대여소·분
- v5 감축량: 6,922.5 대여소·분 — 기존 운영 최선 추정의 약 7.6배
- 이동 1대당 감축량: 기존 운영 최선 추정 1.4, v5 17.3 대여소·분/대 — 약 12.3배

644대와 작업 시각 범위는 실제 차량 로그가 아니라 재고 잔차로 역산한 값이다. 따라서
7.6배와 12.3배는 고정 replay에서의 운영 효율 proxy이며, 실제 기존 운영 대비 인과적
우월성을 뜻하지 않는다.
